                ...
                <div className='menu-wrap'>
                    <div className='menu'>
                        ...
                        <div className='nav-link'>
                            ...
                            <a href='https://www.youtube.com/@1mincook'target="_blank" rel="noopener noreferrer"className='btn main'><FontAwesomeIcon className='icon' icon="fa-solid fa-bowl-rice" /><div className='banner'>더 많은 레시피 보러가기</div></a>
                        </div>
                    </div>
                </div>
            </div>
