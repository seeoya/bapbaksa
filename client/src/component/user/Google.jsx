...
const Google = () => {
    ...
    await axios({
        url: process.env.REACT_APP_SERVER_URL + `/api/auth/google/callback`,                
        method: 'post',      
        data: data,
        
    })
    .then(res => {        
        console.log('AXIOS GOOGLE SIGN_IN COMMUNICATION SUCCESS ==> ', res.data);           
    ...
    .catch(error => {
        console.log('AXIOS GOOGLE SIGN_IN COMMUNICATION ERROR');               
        
    })
    .finally(data => {
        console.log('AXIOS GOOGLE SIGN_IN COMMUNICATION FINALLY');
