...
exports.sendMailForID = async (email, id) => {
    let html =
        "<div style='width: 600px; margin: 20px auto; padding: 30px 50px; border: 1 solid #8fc769; border-radius: 5px; box-shadow: 0 4 8 rgba(0, 0, 0, 0.1);'>" +
        "<div style='display: flex; justify-content: center;'>" +
        "<img src='" +
        logoUrl +
        "' alt='Logo' style='margin: 0 0 20px; max-block-size: 80px;'>" +
        "<span style='margin-left: 10px; font-size: 2rem; font-weight: 700; line-height: 60px; align-items: center;'>Bapbaksa 아이디 찾기</span></div>" +
        "<h2 style='color: #333; text-align: center; margin: 0 0 30px'>아이디 : " +
        id +
        "</h2></div>";
...
exports.sendMailForPW = async (email, pw) => {
    let html =
        "<div style='width: 500px; margin: 20px auto; padding: 30px 50px;'>" +
        "<div style='display: flex; justify-content: center;'>" +
        "<img src='" +
        logoUrl +
        "' alt='Logo' style='margin: 0 0 20px; max-block-size: 80px;'></img>" +
        "<span style='margin-left: 10px; font-size: 2rem; font-weight: 600; line-height: 60px; align-items: center;'>Bapbaksa 비밀번호 찾기</span>" +
        "</div>" +
        "<h2 style='color: #333; text-align: center; margin: 0 0 30px'>임시 비밀번호 : " +
        pw +
        "</h2>" +
        ...
        "<a href='" +
        signinUrl +
        "' style='width: 400px; display: block; margin: 30px auto; text-align: center; padding: 10px 20px; color: #fff; background-color: #6ba543; border-radius: 5px; text-decoration: none;'>로그인하기</a>" +
        "</div>";
